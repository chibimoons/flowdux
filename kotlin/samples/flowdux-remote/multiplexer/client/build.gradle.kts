...
application {
    mainClass.set("io.flowdux.sample.multiplexer.client.MainKt")
}
...
dependencies {
    implementation(project(":kotlin:sample-remote-multiplexer:shared"))
    ...
    implementation(project(":kotlin:flowdux-remote-multiplexer"))
