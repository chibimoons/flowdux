...
- [Room Store Pattern](./pattern-room.md) — Multi-room management, session-aware broadcasting
- [Per-Client Store Pattern](./pattern-per-client.md) — Private state per client (poker hands, portfolios)
